  ...
  async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      if (!['imageMessage', 'videoMessage', 'audioMessage'].includes(messageType)) {
        ...
        return repondre(`NEXUS-AI\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ Yo ${nomAuteurMessage}, that’s not a supported media type (image, video, or audio)! 😣 Nexus can’t work with that! 🚫\n◈━━━━━━━━━━━━━━━━◈`);
      }

      // Notify the user that media is being processed
      await repondre(`NEXUS-AI\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ Yo ${nomAuteurMessage}, nexus ai’s cracking open that media! 📦 Hold tight! 🔍\n◈━━━━━━━━━━━━━━━━◈`);

      // Download the media
      const buffer = await downloadMediaMessage(msgRepondu, 'buffer', {});
      if (!buffer) {
        return repondre(`NEXUS-AI\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ Yo ${nomAuteurMessage}, Nexus ai couldn’t download the media! 😓 Try again or check the message! 🚨\n◈━━━━━━━━━━━━━━━━◈`);
      }

      // Prepare media details
      const caption = msg[messageType].caption || `BOOM! Retrieved by 𝔗𝔬𝔵𝔦𝔠 𝔐𝔇 | Powered by Pkdriller 🔥`;
      const mediaOptions = {
        caption,
        footer: `Hey ${nomAuteurMessage}! I'm Nexus-ai, created by Pkdriller 😎`,
      ...
      // Notify success
      await repondre(`NEXUS-AI\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ BOOM, ${nomAuteurMessage}! nexus ai decrypted and dropped the media right here! 🗿🔥\n◈━━━━━━━━━━━━━━━━◈`);

    } catch (error) {
      console.error("Error in vv command:", error.stack);
      await repondre(`𝐓𝐎𝐗𝐈𝐂-𝐌𝐃\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ TOTAL BUST, ${nomAuteurMessage}! nexus ai tripped while decrypting the media: ${error.message} 😡 Try again or flop! 😣\n◈━━━━━━━━━━━━━━━━◈`);
    }
  }
);
