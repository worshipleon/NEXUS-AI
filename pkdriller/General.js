...
zokou({ nomCom: "dev", categorie: "General", reaction: "⭐" }, async (dest, zk, commandeOptions) => {  
    ...
    let message = "WELCOME TO NEXUS-AI HELP CENTER! ASK FOR HELP FROM THE DEVELOPER BELOW:\n\n";  
