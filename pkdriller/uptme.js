...
zokou({ nomCom: 'uptime2',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_Nexus ai is active since: ${runtime(process.uptime())} ago🏆_*`) 
...
await zk.sendMessage(dest, { image: res, caption: 'powered  𝒃𝒚 * pk driller*'}, { quoted: ms });
