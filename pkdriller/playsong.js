...
fana({
  ...
  try {
    ...
    const _0x2fcfad = ["https://apis-keith.vercel.app/download/dlmp3?url=" + encodeURIComponent(_0x12907a.url), "https://www.dark-yasiya-api.site/download/ytmp3?url=" + encodeURIComponent(_0x12907a.url), "https://api.giftedtech.web.id/api/download/dlmp3?url=" + encodeURIComponent(_0x12907a.url) + "&apikey=gifted-md", "https://api.ryzendesu.vip/api/downloader/ytmp3?url=" + encodeURIComponent(_0x12907a.url)];
