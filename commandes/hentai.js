...
async (origineMessage, zk, commandeOptions) => {
  ...
  const url = 'https://api.waifu.pics/nsfw/waifu'; // Remplace avec ton lien r茅el
...
async (origineMessage, zk, commandeOptions) => {
  ...
  const url = 'https://api.waifu.pics/nsfw/trap'; // Remplace avec ton lien r茅el
...
async (origineMessage, zk, commandeOptions) => {
  ...
  const url = 'https://api.waifu.pics/nsfw/neko'//apiWaifu("neko"); // Remplace avec ton lien r茅el
...
async (origineMessage, zk, commandeOptions) => {
  ...
  const url = 'https://api.waifu.pics/nsfw/blowjob'; // Remplace avec ton lien r茅el
