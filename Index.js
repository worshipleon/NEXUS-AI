...
console.log("Session downloaded ✅")
  ...
  console.log("Connecting PK XMD to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing PK XMD Plugins')
  const path = require('path');
  ...
  let up = `*Hello there ✦ P ✦ K✦ XMD ✦ User! \ud83d\udc4b\ud83c\udffb* \n\n> This is auser friendly whatsapp bot created by PK DRILLER INC. \ud83c\udf8a, Meet ✦ PK XMD ✦ WhatsApp Bot.\n\n *Thanks for using ✦ P ✦ K XMD ✦ \ud83d\udea9* \n\n> follow WhatsApp Channel :- 💖\n \nhttps://whatsapp.com/channel/0029Vad7YNyJuyA77CtIPX0x\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/Pkdriller/PK-XMD\n\n> © Powered BY ✦ PK✦ XMD ✦ \ud83d\udda4`;
